...
namespace ACTV.Core.Model.Seed
{
    public class FrameSeed
    {
        ...
        public static bool CreateControllers(SqlSugarClient sqlSugarClient, string ConnId = null, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ACTV.Core.Api.Controllers", "ACTV.Core.Api.Controllers", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ACTV.Core.Model", "ACTV.Core.Model.Models", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ACTV.Core.IRepository", "ACTV.Core.IRepository", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ACTV.Core.IServices", "ACTV.Core.IServices", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ACTV.Core.Repository", "ACTV.Core.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\ACTV.Core.Services", "ACTV.Core.Services", tableNames, "", isMuti);
            return true;
...
using ACTV.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using ACTV.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using ACTV.Core.IRepository.UnitOfWork;
using ACTV.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using ACTV.Core.Repository.Base;
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using ACTV.Core.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using ACTV.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
