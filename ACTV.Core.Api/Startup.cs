...
using ACTV.Core.Extensions;
using ACTV.Core.Filter;
using ACTV.Core.Hubs;
using ACTV.Core.IServices;
using ACTV.Core.Middlewares;
using ACTV.Core.Model.Seed;
using ACTV.Core.Tasks;
...
namespace ACTV.Core
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("ACTV.Core.Api.index.html"));
